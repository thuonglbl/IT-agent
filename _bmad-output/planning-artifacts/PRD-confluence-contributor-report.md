...
```html
Created by <span class='author'> John DOE</span>, last updated by <span class='editor'> Jane SMITH</span> on Mar 12, 2025
```
→ Created By: `John DOE` | Last Updated By: `Jane SMITH`

**Pattern 2** — Same person created and last updated (no editor span):
```html
Created by <span class='author'> Bob JOHNSON</span>, last updated on Apr 11, 2025
```
→ Created By: `Bob JOHNSON` | Last Updated By: `Bob JOHNSON`
...
|---|-------------------------------------|----------------------------------------------|--------------------|--------------|
| 1 | API manager - Bruno & Postman       | Home > User Knowledge Base                   | John DOE     | Mar 12, 2025 |
| 2 | Print and Scan                      | Home > User Knowledge Base                   | Alice WILLIAMS   | Feb 12, 2025 |
| 3 | Acme Wi-Fi Configuration            | Home > User Knowledge Base > Network         | Charlie BROWN | Apr 01, 2025 |
...

## Bob JOHNSON (6 pages)
| # | Page Title                          | Breadcrumbs                                  | Created By                  | Last Updated |
|---|-------------------------------------|----------------------------------------------|-----------------------------|--------------|
| 1 | Set up Outlook app for IOS          | Home > User KB > Outlook > IOS               | Bob JOHNSON     | Apr 11, 2025 |
| 2 | Enroll Badge for Printers           | Home > User Knowledge Base                   | Bob JOHNSON     | Mar 26, 2025 |
...
...
|-----------------|-----------|-------------|------------|--------------|---------------|----------|
| Jane SMITH | API manager - Bruno & Postman | Home > User Knowledge Base | John DOE | Mar 12, 2025 | 1315046768 | 1315046768.html |
| Bob JOHNSON | Set up Outlook app for IOS | Home > User KB > Outlook > IOS | Bob JOHNSON | Apr 11, 2025 | 1317137011 | Set-up-Outlook-app-for-IOS_1317137011.html |

### 3.3 Summary Statistics

```
TOP LAST EDITORS (by page count):
  1. Jane SMITH              - 12 pages
  2. David MILLER         - 8 pages
  3. Bob JOHNSON   - 6 pages
  ...
